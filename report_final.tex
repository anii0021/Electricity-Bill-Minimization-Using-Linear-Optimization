...
\newcommand{\datasetlink}{\href{https://github.com/your-username/your-repository/blob/main/electricity_bill_dataset.csv}{electricity\_bill\_dataset.csv on GitHub}}
\newcommand{\githublink}{\href{https://github.com/your-username/your-repository}{github.com/your-username/your-repository}}
\newcommand{\rcodefile}{\href{https://github.com/your-username/your-repository/blob/main/code.R}{code.R (view on GitHub)}}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.62\textwidth]{efficiency_ratio.png}
\caption{Savings efficiency ratio}
\label{fig:eff}
\end{figure}
